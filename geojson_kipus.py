...
geojson = dict()
def crear_geojson(df_first,list_ubid,list_address,suma_anuales,list_pisos,list_area,l):
    ...
    for x in range (len(list_ubid)):
        ...
        edificios['features'].append({"type": "Feature", "properties":edificio, "geometry":{"type": "MultiPolygon", "coordinates":[[[[l[x][0][0], l[x][0][1]], [l[x][1][0], l[x][1][1]], [l[x][2][0], l[x][2][1]], [l[x][3][0], l[x][3][1]], [l[x][0][0], l[x][0][1]]]]]}})
