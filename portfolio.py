...
class Portfolio:
    ...
    def read_raw_data_from_xlsx(self, filename):
        # clean up the raw data and save it as a dataframe
        # EXCEL LLEGA HASTA AA
        self.df_meta = pd.read_excel(filename, sheet_name="datos_procesados", usecols="A:AE")
        ...
        self.df_meta.columns = ['region_id','comuna','institution', "building_name", "building_address","building_ID" ,"building_area",
                    ...
                    'latitude','longitude','altura','num_institution','building_cooling_fuel_type','building_heating_fuel_type','currency']
